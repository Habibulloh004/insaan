...
const ReviewCardGoriz = ({ name, rating, level, text }) => {
  return (
    <div className="w-11/12 lg:w-10/12 flex-col md:flex-row flex justify-center items-center relative mx-auto bg-white rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.15)] p-6 text-center">
